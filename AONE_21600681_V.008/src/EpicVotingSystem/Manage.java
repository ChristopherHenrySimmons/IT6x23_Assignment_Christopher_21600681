    	    	     		...
    	    	     		public boolean Managedate()
    	    	    	     {
    	    	    	        ...
    	    	    	        while (!dateQuit){
    	    	    	            System.out.println("\t\t date Information System\n\n");
    	    	    	 	        ...
    	    	    	 	        System.out.println("\"V\" :View date Record ");	
...
//    	    	    	            System.out.println("Good Bye... : \n\n");
								...
								//Create setter method add record
    	    	    	         public void dAddRecord() throws IOException {
    	    	    	        	 System.out.println("If you wish to change date, go into Class VotingController and manually do it");
...
//									System.out.println("Todays Date"+""+sdf.format(date) );
    								System.out.println("This method should of been build in VC");
    								System.out.println("with all the values all ready set");
    								System.out.println("If u still wish to see date look at the bottem right of screen");
